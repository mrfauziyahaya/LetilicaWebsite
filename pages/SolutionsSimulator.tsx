      ...
      <Section>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div className="order-2 lg:order-1">
            ...
            <div className="order-1 lg:order-2 h-80 w-full bg-slate-800 rounded-sm border border-slate-700 flex items-center justify-center overflow-hidden">
             <img src="/assets/img/simulation-system-fpv.jpeg" alt="Simulator System" className="w-full h-full object-cover" />
            </div>
        </div>
