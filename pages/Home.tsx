        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="group bg-slate-800 border border-slate-700 hover:border-sky-600 transition-all duration-300 flex flex-col">
            <div className="h-48 w-full bg-slate-700 relative overflow-hidden">
               <img src="https://picsum.photos/600/400?random=1" alt="Drone" className="w-full h-full object-cover opacity-60 group-hover:opacity-80 transition-opacity" />
          ...
          <div className="group bg-slate-800 border border-slate-700 hover:border-amber-600 transition-all duration-300 flex flex-col">
            <div className="h-48 w-full bg-slate-700 relative overflow-hidden">
               <img src="https://picsum.photos/600/400?random=2" alt="Radar" className="w-full h-full object-cover opacity-60 group-hover:opacity-80 transition-opacity" />
          ...
          <div className="group bg-slate-800 border border-slate-700 hover:border-sky-600 transition-all duration-300 flex flex-col">
            <div className="h-48 w-full bg-slate-700 relative overflow-hidden">
               <img src="https://picsum.photos/600/400?random=3" alt="Simulator" className="w-full h-full object-cover opacity-60 group-hover:opacity-80 transition-opacity" />
